        ...
        <div class="container">
            ...
            <div class="row">
                @foreach($goods_info as $v)
                    <div class="col s6">
                        <div class="content">
                            <a href="{{url('home/product')}}?id={{$v->id}}"><img src='{{asset("$v->goods_pic")}}'  alt="" style="width:300px;height:300px"></a>
                            <h6><a href="">Fashion Men's</a></h6>
                            <div class="price">
                                ${{$v->goods_price}} <span>$28</span>
                            </div>
                            <a class="btn button-default"  href="{{url('home/product')}}?id={{$v->id}}">ADD TO CART</a>
                        </div>
                    </div>
                @endforeach
            </div>
